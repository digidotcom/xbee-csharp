  Introduction
  ------------
  This sample C# application shows how to receive and process data coming
  from other interfaces of the XBee device using the XBee C# Library.

  The application registers a callback executed every time a new User Data
  Relay message is received and prints the interface that sent the message
  and the data of the message.
  ...
  -----
    * MainApp.cs:
      ...
      serial connection with it and registers the callback that handles the 
      received User Data Relay messages.
  ...
  interface and data is printed out in the console of the launched application:
    ...
    Data received from Bluetooth Low Energy >> 48 65 6C 6C 6F 20 58 42 65 65 21 | 'Hello XBee!'